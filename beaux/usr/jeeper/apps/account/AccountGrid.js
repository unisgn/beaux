            ...
            columns: [{
                ...
                renderer: function(value, meta, record) {
                    var FAT = Jeeper.lib.FinancialAccountType,
                        ...
                        isDebitBalance = record.get('isDebitBalance'),
                        isR = FAT.isRetainedEarnings(type),
                        isAsset = FAT.isAsset(type),
                        convertedBalance = isAsset ? (isDebitBalance ? value : -value) : (isDebitBalance ? -value : value);
                    return isR ? this.balanceNA : Ext.util.Format.customnumber(convertedBalance, '0,0.00');
                }
            }]
        });
        me.on({
